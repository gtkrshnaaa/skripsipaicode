...
\begin{table}[htbp]
  ...
  \footnotesize
  \begin{tabular}{@{}p{0.09\textwidth}p{0.09\textwidth}p{0.15\textwidth}>{\hyphenpenalty=50\tolerance=1000}p{0.12\textwidth}>{\hyphenpenalty=50\tolerance=1000}p{0.13\textwidth}>{\hyphenpenalty=50\tolerance=1000}p{0.14\textwidth}p{0.16\textwidth}@{}}
    \toprule

...
\begin{table}[htbp]
  ...
  \footnotesize
  \begin{tabular}{@{}p{0.12\textwidth}p{0.12\textwidth}p{0.18\textwidth}>{\raggedright\arraybackslash\hyphenpenalty=50}p{0.12\textwidth}>{\raggedright\arraybackslash\hyphenpenalty=50}p{0.14\textwidth}>{\raggedright\arraybackslash\hyphenpenalty=50}p{0.14\textwidth}p{0.14\textwidth}@{}}
    \toprule

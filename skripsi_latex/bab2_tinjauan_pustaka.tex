...
\begin{itemize}
  ...
  \item \textbf{Modifikasi terarah dengan threshold}: perintah \texttt{MODIFY} memanfaatkan \textit{diff} untuk membatasi ruang perubahan hingga maksimal 500 baris (dapat dikonfigurasi), mendukung prinsip perubahan minimal dan fokus seperti Cascade.

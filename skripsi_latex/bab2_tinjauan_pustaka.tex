...
\begin{table}[htbp]
  ...
  \begin{tabular}{|p{0.09\textwidth}|p{0.09\textwidth}|p{0.15\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.12\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.12\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.13\textwidth}|p{0.15\textwidth}|}
    \hline

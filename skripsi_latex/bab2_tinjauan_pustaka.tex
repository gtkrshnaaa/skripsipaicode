...
\begin{table}[htbp]
  ...
  \small
  \begin{tabular}{@{}lp{0.14\textwidth}p{0.16\textwidth}p{0.15\textwidth}p{0.13\textwidth}p{0.12\textwidth}p{0.12\textwidth}@{}}
    \toprule
    \textbf{Penelitian} & \textbf{Platform} & \textbf{Arsitektur} & \textbf{Keamanan} & \textbf{Transparansi} & \textbf{Efisiensi} & \textbf{Interaktivitas} \\
    \midrule
    ...
    \midrule
    OpenDevin & Container & Fully autonomous & Sandboxed & Verbose logs & Resource-intensive & Autonomous \\
    \midrule
    SWE-agent & General & Autonomous & Sandboxed & Verbose logs & Resource-intensive & Autonomous \\
    \midrule
    \textbf{Paicode} & \textbf{CLI native} & \textbf{Single-Shot (2 phases)} & \textbf{Path security + diff} & \textbf{JSON planning} & \textbf{Token-optimized} & \textbf{Semi-autonomous + Ctrl+C} \\
    \bottomrule
  \end{tabular}
\end{table}

...
Bagian ini menampilkan gambar ilustratif yang mendukung narasi pada Bab~\ref{chap:tinjauan}. Gambar bersifat konseptual dengan placeholder yang akan diganti dengan implementasi aktual.
...
\begin{figure}[htbp]
  ...
  (Skema loop: input pengguna → perencanaan → eksekusi alat → hasil → memori)}}

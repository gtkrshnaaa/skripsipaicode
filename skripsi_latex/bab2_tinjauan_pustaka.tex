...
\begin{itemize}
  ...
  \item \textbf{Arsitektur Single-Shot Intelligence}: alur kerja efisien yang mengoptimalkan penggunaan API dengan 2 fase utama (perencanaan dan eksekusi), menggantikan pendekatan tradisional yang memerlukan 10-20 panggilan API.

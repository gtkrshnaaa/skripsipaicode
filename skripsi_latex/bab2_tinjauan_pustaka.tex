...
\begin{table}[htbp]
  ...
  \footnotesize
  \setlength{\tabcolsep}{3pt} % Reduce padding to fit 7 columns
  \begin{tabular}{|p{0.10\textwidth}|p{0.10\textwidth}|p{0.16\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.125\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.125\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.135\textwidth}|p{0.16\textwidth}|}
    \hline

...
\begin{table}[htbp]
  ...
  \footnotesize
  \begin{tabular}{@{}p{0.09\textwidth}p{0.10\textwidth}p{0.14\textwidth}p{0.11\textwidth}p{0.11\textwidth}p{0.12\textwidth}p{0.13\textwidth}@{}}
    \toprule
    ...
    \midrule
    \textbf{Paicode} & \textbf{CLI native} & \textbf{Single-Shot (2 phases)} & \textbf{Path security + diff} & \textbf{JSON planning} & \textbf{Token-optimized} & \textbf{Semi-auto\-nomous + Ctrl+C} \\
    \bottomrule
  \end{tabular}
\end{table}

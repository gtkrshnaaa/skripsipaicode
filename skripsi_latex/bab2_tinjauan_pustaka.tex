...
\begin{table}[htbp]
  ...
  \footnotesize
  \begin{tabular}{|p{0.08\textwidth}|p{0.08\textwidth}|p{0.14\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.11\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.12\textwidth}|>{\hyphenpenalty=50\tolerance=1000}p{0.13\textwidth}|p{0.15\textwidth}|}
    \hline

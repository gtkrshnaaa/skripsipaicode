...
Paicode dijalankan pada terminal lokal dan melakukan tindakan langsung pada sistem berkas. Akan tetapi, untuk kebutuhan inferensi, cuplikan kode atau konteks \textbf{dikirim ke layanan LLM melalui API}. Implikasinya, privasi dan kerahasiaan kode \textbf{bergantung pada kebijakan penyedia API}. Pengamanan di sisi lokal tetap diterapkan melalui kebijakan keamanan jalur serta pembatasan perubahan berbasis \textit{diff} agar operasi berkas lebih terkendali.

...
\begin{enumerate}
  \item Bagaimana merancang arsitektur agen AI berbasis CLI yang \textit{stateful} dan \textit{proactive} dengan integrasi LLM melalui API, disertai kebijakan keamanan \textit{path} dan pembatasan perubahan berbasis \textit{diff} untuk mendukung proses pengembangan perangkat lunak?
  \item Bagaimana mengintegrasikan kemampuan observasi proyek, manipulasi berkas, serta modifikasi kode terarah berbasis deskripsi pengguna dengan pengamanan terhadap \textit{path} dan direktori sensitif?

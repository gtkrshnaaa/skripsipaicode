...
\begin{enumerate}
  ...
  \item Bagaimana mengimplementasikan kebijakan keamanan \textit{path} dan pembatasan perubahan berbasis \textit{diff} dengan threshold ganda (500 baris absolut dan 50\% ratio maksimal) untuk mencegah penimpaan berkas yang tidak diinginkan dan akses ke direktori sensitif?

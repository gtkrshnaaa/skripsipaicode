...
\textbf{SENSITIVE \_PATTERNS} & Daftar 7 pola direktori/berkas sensitif yang diblokir akses: \\
& \texttt{.env}, \texttt{.git}, \texttt{venv}, \texttt{\_\_pycache\_\_}, \texttt{.pai\_history}, \texttt{.idea}, \texttt{.vscode}. \\

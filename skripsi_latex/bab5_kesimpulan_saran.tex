...
\begin{itemize}
  ...
  \item \textbf{Integrasi editor}: menyediakan jembatan ringan ke IDE (mis. VS Code) yang memanggil agen CLI, sambil tetap menegaskan bahwa inferensi LLM dilakukan via API sesuai kebijakan penyedia.
  \item \textbf{Peningkatan keamanan}: memperluas kebijakan \textit{allow/deny list} \textit{path}, menambah konfirmasi eksplisit untuk operasi berisiko, dan memperketat validasi konten sebelum penulisan berkas.

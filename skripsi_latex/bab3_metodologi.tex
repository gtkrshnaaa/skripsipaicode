...
\begin{itemize}
  ...
  \item \textbf{Gerbang Sistem Berkas (\texttt{fs.py})}: menyediakan operasi berkas dengan kebijakan keamanan (validasi jalur, blokir direktori sensitif), serta mekanisme \textit{diff}-aware untuk \texttt{MODIFY}.

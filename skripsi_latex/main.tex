...
\captionsetup[subfigure]{labelformat=mysublab, labelsep=colon, skip=20pt}
...
\setlength{\parindent}{1em} % Keep paragraph indentation
...
% Style for frontmatter: page number at top right
...
% Style for mainmatter: page number at bottom center
...
% Style for chapter pages in mainmatter

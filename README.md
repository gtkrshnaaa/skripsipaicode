...
# Repository Skripsi Gilang Teja Krishna

Repository ini berisi objek penelitian untuk skripsi saya yang berjudul "Paicode: Agentic AI berbasis CLI untuk membantu proses coding secara interaktif ditenagai LLM eksternal via API".
...
Kompilasi LaTeX jadi PDF (`skripsi.pdf`) dengan perintah:
